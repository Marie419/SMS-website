        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/management" className="hover:text-orange">Management</Link></li>
              <li><Link to="/news" className="hover:text-orange">News & Event</Link></li>
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a href="#" className="bg-gray-800 p-2 rounded-full hover:bg-orange transition-colors">
